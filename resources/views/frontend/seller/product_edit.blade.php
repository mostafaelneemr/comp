...
<link rel="stylesheet" type="text/css" href="{{ url('./public/lou-multi/css/multi-select.css') }}">
    ...
    <section class="gry-bg py-4 profile">
        ...
        @endif
                        <form class="" action="{{route('products.seller_update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Name English')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_en" value="{{  $product->name_en}}" placeholder="{{ translate('Product Name English')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Name Arabic')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_ar" value="{{  $product->name_ar }}" placeholder="{{ translate('Product Name Arabic')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-md-2">{{ translate('Product Country Arabic') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="country_ar"
                                                placeholder="{{ translate('Product Country Arabic') }}"
                                                value="{{ $product->country_ar }}" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <label class="col-md-2">{{ translate('Product Country English') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="country_en"
                                                placeholder="{{ translate('Product Country English') }}"
                                                value="{{ $product->country_en }}" required>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            @else
                                            <div class="form-control mb-3 c-pointer" data-toggle="modal" data-target="#categorySelectModal" id="product_category"></div>

                                            @endif
                                            <input type="hidden" name="category_id" id="category_id" value="{{ ($product->category) ? $product->category->id : null }}" required>
                                            <input type="hidden" name="subcategory_id" id="subcategory_id" value="{{ ($product->subcategory)? $product->subcategory->id : null }}" required>
                                            <input type="hidden" name="subsubcategory_id" id="subsubcategory_id" value="{{ ($product->subsubcategory != null)?$product->subsubcategory->id: null }}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Tag English')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_en[]" placeholder="{{ translate('Type & hit enter English') }}" data-role="tagsinput" value="{{ $product->tags_en }}">
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Tag Arabic')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_ar[]" placeholder="{{ translate('Type & hit enter Arabic') }}" data-role="tagsinput" value="{{ $product->tags_ar }}">
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Meta Title English')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" value="{{ $product->meta_title_en }}" name="meta_title_en" class="form-control mb-3" placeholder="{{ translate('Meta Title English')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Meta Title Arabic')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" value="{{ $product->meta_title_ar }}" name="meta_title_ar" class="form-control mb-3" placeholder="{{ translate('Meta Title Arabic')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Description English')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <textarea name="meta_description_en" rows="8" class="form-control mb-3">{{ $product->meta_description_en }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Description Arabic')}}</label>
                                        </div>
                                        <div class="col-md-10">
                                            <textarea name="meta_description_ar" rows="8" class="form-control mb-3">{{ $product->meta_description_ar }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->meta_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img loading="lazy"  src="{{ uploaded_asset($product->meta_img) }}" alt="" class="img-responsive">
                                        ...
                                        @foreach (json_decode($product->choice_options) as $key => $choice_option)
        									<div class="row mb-3">
        										<div class="col-8 col-md-3 order-1 order-md-0">
        											...
        											<input type="text" class="form-control" name="choice[]" value="{{ \App\Attribute::select(['*','name_'.locale().' as name'])->find($choice_option->attribute_id)->name }}" placeholder="{{ translate('Choice Title') }}" disabled>
        										</div>
        										<div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <textarea class="editor" name="description_en">{{$product->description_en}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <textarea class="editor" name="description_ar">{{$product->description_ar}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
        ...
        function get_subcategories_by_category(el, cat_id){
            ...
            $('#subsubcategory_list').hide();
            $.post('{{ route('categories.get_subcategories_by_category') }}',{_token:'{{ csrf_token() }}', category_id:category_id}, function(data){
        ...
        function get_subsubcategories_by_subcategory(el, subcat_id){
            ...
            $.post('{{ route('categories.get_subcategories_by_category') }}',{_token:'{{ csrf_token() }}', category_id:subcategory_id}, function(data){
                for (var i = 0; i < data.length; i++) {
    	...
    	function update_sku(){
            $.ajax({
    		   type:"POST",
    		   url:'{{ route('products.sku_combination_edit_front') }}',
