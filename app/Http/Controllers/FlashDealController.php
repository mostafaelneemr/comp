...
class FlashDealController extends Controller
{
    ...
    {
        $sort_search = null;
        $flash_deals = FlashDeal::select(['*', 'title_' . locale() . ' as title'])->orderBy('created_at', 'desc');
    ...
    public function store(Request $request)
    {
        ...
        $flash_deal->slug_en = strtolower(str_replace(' ', '-', $request->title_en) . '-' . Str::random(5));
        $flash_deal->slug_ar = strtolower(str_replace(' ', '-', $request->title_ar) . '-' . Str::random(5));
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($flash_deal->save()) {
            ...
            if ($request->button != 'save') {
                ...
                return redirect()->route('flash_deals.edit', encrypt($flash_deal->id));
            }
