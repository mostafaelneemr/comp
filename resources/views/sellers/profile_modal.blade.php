<div class="modal-body">
    ...
    <div class="text-center">
        <span class="avatar avatar-xxl mb-3">
            <img src="{{ my_asset($seller->user->avatar_original) }}">
        </span>
    ...
    <p><i class="demo-pli-map-marker-2 icon-lg icon-fw mr-1"></i>{{ $seller->user->shop->{'address_' .locale() } }}</p>
    <p><a href="{{ route('shop.visit', $seller->user->shop->slug) }}" class="btn-link"><i class="demo-pli-internet icon-lg icon-fw mr-1"></i>{{ $seller->user->shop->{'name_' . locale() } }}</a></p>
