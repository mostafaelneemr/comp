                            ...
                            <div class="card-header py-3">
                                ...
                                <ul class="list-inline alpha-6 mb-0">
                                    <li class="list-inline-item">
                                        {{ date('h:i:m A d-m-Y', strtotime($ticket->created_at)) }}</li>
                                    <li class="list-inline-item"><span class="badge badge-pill badge-secondary">Open</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="card-body">
                                <div class="border-bottom pb-4">
                                    <form class="" action="{{ route('support_ticket.seller_store') }}" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="ticket_id" value="{{ $ticket->id }}">
                                        <input type="hidden" name="user_id" value="{{ $ticket->user_id }}">
                                        <div class="form-group">
                                            <textarea class="form-control editor" name="reply"
                                                placeholder="{{ translate('Type your reply') }}"
                                                data-buttons="bold,underline,italic,|,ul,ol,|,paragraph,|,undo,redo"></textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-right">
                                            <button type="submit"
                                                class="btn btn-base-1">{{ translate('Send Reply') }}</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="pt-4">
                                        ...
                                        @if ($ticket->user_id == $ticketreply->user_id)
                                            <div class="block block-comment mb-3 border-0">
                                                <div class="d-flex flex-row-reverse">
                                                    <div class="pl-3">
                                                        <div class="block-image d-block size-40" data-toggle="tooltip"
                                                            data-title="{{ $ticketreply->user->name }}">

                                                            @if ($ticketreply->user->avatar_original === null)
                                                                <img src="{{ my_asset($ticketreply->user->avatar_original) }}"
                                                                    class="rounded-circle">
                                                            @else
                                                                <img src="{{ my_asset('frontend/images/user.png') }}"
                                                                    class="rounded-circle">
                                                            @endif
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex">
                                                    <div class="pr-3">
                                                        <div class="block-image d-block size-40" data-toggle="tooltip"
                                                            data-title="{{ $ticketreply->user->name }}">
                                                            <img loading="lazy"
                                                                src="{{ uploaded_asset($ticketreply->user->avatar_original) }}"
                                        ...
                                        <div class="d-flex flex-row-reverse">
                                            <div class="pl-3">
                                                <div class="block-image d-block size-40">
                                                    <img loading="lazy"
                                                        src="{{ my_asset($ticket->user->avatar_original) }}"
                                                        class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="flex-grow-1 ml-5 pl-5">
