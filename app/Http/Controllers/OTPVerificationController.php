...
class OTPVerificationController extends Controller
{
    ...
    public function reset_password_with_code_email(Request $request)
    {
     ...
     * @return void
     */
    public function send_order_code($phone, $code)
    {
        // return $phone;
        // sendOtp();
        sendSMS($phone, env('APP_NAME'), 'You order has been placed and Order Code is : ' . $code);
    }
