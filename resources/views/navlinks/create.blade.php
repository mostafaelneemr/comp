  ...
  <form class="form-horizontal" action="{{ route('navlinks.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      ...
      <div class="form-group row">
          ...
          <div class="col-md-8">
              <input type="text" class="form-control" name="link" placeholder="{{ translate('Title Arabic') }}"
                  id="link" required>
          </div>
      </div>
