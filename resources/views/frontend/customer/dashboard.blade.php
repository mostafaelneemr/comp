                                            ...
                                            @if($address != null)
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="p-2">
                                                            {{ ($address->addressCountry) ? $address->addressCountry->{'name_' . locale()} : '' }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ translate('Province') }}:</td>
                                                        <td class="p-2">{{ ($address->addressProvince) ?  $address->addressProvince->{'name_' . locale()} : '' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ translate('City') }}:</td>
                                                        <td class="p-2">{{ ($address->addressCity) ? $address->addressCity->{'name_' . locale()} : '' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ translate('Region') }}:</td>
                                                        <td class="p-2">{{ ($address->addressRegion) ? $address->addressRegion->{'name_' . locale()} : ''}}</td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="form-box-content p-3">
                                            @if($customer_package != null)
                                                <div class="form-box-content p-2 category-widget text-center">
                                                    <center><img alt="Package Logo" src="{{ uploaded_asset($customer_package->{'logo_'.locale()}) }}" style="height:100px; width:90px;"></center>
                                                    <br>
                                                    ...
                                                    <strong><p><div class="name mb-0">{{ translate('Current Package') }}: {{ $customer_package->{'name_'.locale()} }} <span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span></div></p></strong>
                                                </div>
                                            @else
                                                <div class="form-box-content p-2 category-widget text-center">
