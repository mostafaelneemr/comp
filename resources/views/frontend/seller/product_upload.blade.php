            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="{{ route('seller.products') }}">{{ translate('Products') }}</a>
                                            </li>
                                            <li class="active"><a
                                                    href="{{ route('seller.products.upload') }}">{{ translate('Add New Product') }}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        @endif
                        <form class="" action="{{ route('products.seller_store') }}" method="POST" enctype="multipart/form-data"
                            id="choice_form">
                            @csrf
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Name English') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_en"
                                                placeholder="{{ translate('Product Name English') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Name Arabic') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_ar"
                                                placeholder="{{ translate('Product Name Arabic') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label
                                            class="col-md-2">{{ translate('Product Country Arabic') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="country_ar"
                                                placeholder="{{ translate('Product Country Arabic') }}" required>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <label
                                            class="col-md-2">{{ translate('Product Country English') }}</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" name="country_en"
                                                placeholder="{{ translate('Product Country English') }}" required>
                                        </div>
                                    </div>
                                    <br>
                                    {{-- <br>
                                    <div class="row" id="category">
                                        <label class="col-lg-2 col-md-2">{{ translate('Category') }}</label>
                                    ...
                                    <div class="row" id="subcategory">
                                        <label class="col-lg-2 col-md-2">{{ translate('Subcategory') }}</label>
                                        <div class="col-lg-10 col-md-10">
                                    ...
                                    <div class="row" id="subsubcategory">
                                        <label class="col-lg-2 col-md-2">{{ translate('Sub Subcategory') }}</label>
                                        <div class="col-lg-10 col-md-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="form-control mb-3 c-pointer" data-toggle="modal"
                                                ...
                                                {{ translate('Select a category') }}</div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Minimum Qty.') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Tag English') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_en[]"
                                                placeholder="{{ translate('Type & hit enter English') }}"
                                                data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Product Tag Arabic') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_ar[]"
                                                placeholder="{{ translate('Type & hit enter Arabic') }}"
                                                data-role="tagsinput">
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title_en" class="form-control mb-3"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title_ar" class="form-control mb-3"
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Meta Image') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Unit Price') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Purchase Price') }} <span
                                                    class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3"
                                                name="purchase_price" placeholder="{{ translate('Purchase Price') }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3"
                                                name="tax" placeholder="{{ translate('Tax') }}" required>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3"
                                                name="discount" placeholder="{{ translate('Discount') }}" required>
                                        </div>
                                        <div class="col-4 col-md-2">
                                            <div class="mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12" id="sku_combination_front">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" min="0" step="0.01" value="0" class="form-control mb-3"
                                                    name="free_shipping_cost" value="0" disabled
                                                    placeholder="{{ translate('Flat Rate Cost') }}">
                                            </div>
                                            <div class="col-md-2">
                                                <label class="switch" style="margin-top:5px;">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <textarea class="editor" name="description_en"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="target-category heading-6">
                        ...
                        <span>{{ translate('category') }} > {{ translate('subcategory') }} >
                            {{ translate('subsubcategory') }}</span>
                    </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        function get_subcategories_by_category(el, cat_id) {
            ...
            $('#subsubcategory_list').hide();
            $.post('{{ route('categories.get_subcategories_by_category') }}', {
                _token: '{{ csrf_token() }}',
        ...
        function add_more_customer_choice_option(i, name) {
            $('#customer_choice_options').append(
                ...
                '" placeholder="{{ translate('Choice Title') }}" readonly></div><div class="col-12 col-md-7 col-xl-8 order-3 order-md-0 mt-2 mt-md-0"><input type="text" class="form-control tagsInput" name="choice_options_' +
                i +
                '[]" placeholder="{{ translate('Enter choice values') }}" onchange="update_sku()"></div><div class="col-4 col-xl-1 col-md-2 order-2 order-md-0 text-right"><button type="button" onclick="delete_row(this)" class="btn btn-link btn-icon text-danger"><i class="fa fa-trash-o"></i></button></div></div>'
            );
            // i++;
        ...
        function update_sku() {
            $.ajax({
                type: "POST",
                url: '{{ route('products.sku_combination_front') }}',
                data: $('#choice_form').serialize(),
                success: function(data) {
                    $('#sku_combination_front').html(data);
                    if (data.length > 1) {
                        $('#quantity').hide();
                    } else {
                        $('#quantity').show();
