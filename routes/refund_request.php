...
Route::group([
    ...
    //Admin
    Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin','can:21']], function () {
        ...
        Route::get('/refund-request-pay', 'RefundRequestController@refund_pay')->name('refund_request_money_by_admin');
        Route::post('/getRefunded', 'RefundRequestController@getRefunded')->name('getRefunded');
    ...
    Route::group(['middleware' => ['user', 'verified']], function () {
        ...
        Route::get('cancel_order_user/{id}', 'RefundRequestController@cancel_order_user')->name('cancel_order_user');
    });
