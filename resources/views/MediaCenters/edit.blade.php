...
@section('content')
    <form class="form-horizontal" action="{{ route('MediaCenters.update', $MediaCenter->id) }}" method="POST"
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ $MediaCenter->alt_en }}" placeholder="{{ translate('English Alt') }}" id="alt_en" name="alt_en"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{ $MediaCenter->alt_ar }}" class="form-control" name="alt_ar"
