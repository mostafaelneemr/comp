    ...
    <div class="aiz-titlebar text-left mt-2 mb-3">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-right">
                ...
                <a href="{{ action('SellerController@exportt') }}" class="btn btn-circle btn-info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($seller->user->banned == 1) <i
                                                class="fa fa-ban text-danger" aria-hidden="true"></i> @endif {{ $seller->user->name }}
                                    </td>
                                    ...
                                    <td class="text-right">
                                        @isset($seller->user->shop->id)
                                            <a href="javascript:void(0)" title="{{ translate('Copy Deep Link') }}"
                                                ...
                                                data-url="{{ route('shop.visit', $seller->user->shop->id) }}">
