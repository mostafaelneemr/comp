                ...
                <div class="card-body">
                    <form action="{{ route('flash_deals.store') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="title_en">{{ translate('Title English') }}</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 control-label" for="title_ar">{{ translate('Title Arabic') }}</label>
                            <div class="col-sm-9">
                                <input type="text" placeholder="{{ translate('Title Arabic') }}" id="title_ar"
                            ...
                            <div class="col-sm-9">
                                <select name="products[]" id="products" class="form-control aiz-selectpicker" multiple
                                    ...
                                    @foreach (\App\Product::orderBy('created_at', 'desc')->get() as $product)
                                        <option value="{{ $product->id }}">{{ $product->{'name_' . locale()} }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
