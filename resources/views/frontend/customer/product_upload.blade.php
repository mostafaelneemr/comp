                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_en" placeholder="{{ translate('Product Name English')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="name_ar" placeholder="{{ translate('Product Name Arabic')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="location_ar" placeholder="{{ translate('Location Ar') }}"  required>
                                        </div>
                                    </div>
                                        <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="location_en" placeholder="{{ translate('Location En') }}"  required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_en[]" placeholder="{{ translate('Type & hit enter English') }}" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_ar[]" placeholder="{{ translate('Type & hit enter Arabic') }}" data-role="tagsinput">
                                        </div>
                                    </div>
                                    @php
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title_en" class="form-control mb-3" placeholder="{{ translate('Meta Title English')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="meta_title_ar" class="form-control mb-3" placeholder="{{ translate('Meta Title Arabic')}}">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="meta_description_en" rows="8" class="form-control mb-3"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="meta_description_ar" rows="8" class="form-control mb-3"></textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="unit_discount" placeholder="{{ translate('Discount') }}" required>
                                        </div>
                                        <div class="col-4 col-md-2">
                                            <div class="mb-3">
                        ...
                        <div class="col-4">
                            <div class="modal-category-box c-scrollbar">
                                ...
                                <div class="modal-category-list has-right-arrow">
                                    <ul id="categories">
                                        @foreach ($categories as $key => $category)
                                            <li onclick="get_subcategories_by_category(this, {{ $category->id }})">{{  $category->{'name_'.locale()} }}</li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
