            ...
            <div class="col">
                <ul class="breadcrumb">
                    ...
                    <li><a href="{{ route('products') }}">{{ translate('All Categories')}}</a></li>
                        ...
                        <li ><a href="{{ route('products.category', \App\Category::find($detailedProduct->category_id)->slug) }}">{{ \App\Category::find($detailedProduct->category_id)->{'name_'.locale()} }}</a></li>
                        <li ><a href="{{ route('products.subcategory', \App\SubCategory::find($detailedProduct->subcategory_id)->slug) }}">{{ \App\SubCategory::find($detailedProduct->subcategory_id)->{'name_'.locale()} }}</a></li>
                        <li ><a href="{{ route('products.subsubcategory', \App\SubSubCategory::find($detailedProduct->subsubcategory_id)->slug) }}">{{ \App\SubSubCategory::find($detailedProduct->subsubcategory_id)->{'name_'.locale()} }}</a></li>
                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-6">
                        <div class="product-gal sticky-top d-flex flex-row-reverse">
                            @if(is_array(explode(',',$detailedProduct->photos)) && count(explode(',',$detailedProduct->photos)) > 0)
                                <div class="product-gal-img">
                                    <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" class="xzoom img-fluid lazy" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset(explode(',',$detailedProduct->photos)[0]) }}" xoriginal="{{ uploaded_asset(explode(',',$detailedProduct->photos)[0]) }}" />
                                </div>
                                <div class="product-gal-thumb">
                                    <div class="xzoom-thumbs">
                                        @foreach (explode(',',$detailedProduct->photos) as $key => $photo)
                                            <a href="{{ uploaded_asset($photo) }}">
                                                <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" class="xzoom-gallery lazy" src="{{ my_asset('frontend/images/placeholder.jpg') }}" width="80" data-src="{{ uploaded_asset($photo) }}"  @if($key == 0) xpreview="{{ uploaded_asset($photo) }}" @endif>
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
...
{{--                                @endif--}}
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                                <div class="row no-gutters mt-3">
                                    ...
                                    <div class="col-10">
                                        <a href="{{ route('returnpolicy') }}" target="_blank"> @if ($refund_sticker != null && $refund_sticker->value != null) <img src="{{ uploaded_asset($refund_sticker->value) }}" height="36"> @else <img src="{{ my_asset('frontend/images/refund-sticker.jpg') }}" height="36"> @endif</a>
                            ...
                            <div class="row no-gutters mt-3">
                                ...
                                <div class="col-10">
                                    <ul class="inline-links">
                                        <li>
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset('frontend/images/icons/cards/visa.png') }}" width="30" class="lazy">
                                        </li>
                                        <li>
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset('frontend/images/icons/cards/mastercard.png') }}" width="30" class="lazy">
                                        </li>
                                        <li>
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset('frontend/images/icons/cards/maestro.png') }}" width="30" class="lazy">
                                        </li>
                                        <li>
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset('frontend/images/icons/cards/paypal.png') }}" width="30" class="lazy">
                                        </li>
                                        <li>
                                            <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset('frontend/images/icons/cards/cod.png') }}" width="30" class="lazy">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="clearfix">
                                    <div class="product-image float-left">
                                        <a href="{{ route('product', $top_product->slug) }}">
                                            <img class="img-fit lazy" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ uploaded_asset($top_product->thumbnail_img) }}" alt="{{  translate($top_product->name) }}">
                                        </a>
                                    </div>
                                        ...
                                        @foreach ($detailedProduct->reviews as $key => $review)
                                            <div class="block block-comment">
                                                <div class="block-image">
                                                    <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($review->user->avatar_original) }}" class="rounded-circle lazy">
                                                </div>
                                        ...
                                        <div class="col-5">
                                            <div class="position-relative overflow-hidden h-100">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center">
                                                    <img class="img-fit lazy" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ uploaded_asset($related_product->thumbnail_img) }}" alt="{{  translate($related_product->name) }}">
                                                </a>
                                            </div>
                                        </div>
