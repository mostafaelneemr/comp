                                            ...
                                            <div class="col-lg-6">
                                                <div class="border p-3 pr-5 rounded mb-3 position-relative">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            class="strong-600 ml-2">{{ \App\Country::where('id', $address->country)->value('name_' . locale()) }}</span>
                                                    </div>
                                                    <div>
                                                    ...
                                                    @if ($address->set_default)
                                                        <div class="position-absolute right-0 bottom pr-2 pb-3">
                                                            <span
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <label class="switch mb-3">
                                                <input value="1" name="cash_on_delivery_status" type="checkbox" @if (Auth::user()->seller->cash_on_delivery_status == 1) checked
                                                @endif>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <label class="switch mb-3">
                                                <input value="1" name="bank_payment_status" type="checkbox" @if (Auth::user()->seller->bank_payment_status == 1)
                                                checked @endif>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                ...
                <div class="container" id="add-adress-fill-container">
                    ...
                    <div class="existing-phone-container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control mb-3  selectpicker" onchange="setInputPhone(this)"
                                        data-placeholder="{{ translate('Select your phone') }}">
                                        <option selected disabled>{{ translate('Select Your Phone') }}</option>

                                        @foreach (\App\Phone::where(['user_id' => Auth::user()->id, 'status' => 'actived'])
            ->select('id', 'phone')
            ->get()
        as $key => $phonee)
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                <select class="form-control mb-3  selectpicker"
                                                    ...
                                                    @foreach (\App\Country::where('status', 1)
