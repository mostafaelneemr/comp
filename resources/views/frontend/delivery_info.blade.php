                        ...
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="cart-item">
                                                        <td class="product-image" width="25%">
                                                            <a href="{{ route('product', \App\Product::find($id)->{'slug_'.locale()}) }}" target="_blank">
                                                                <img loading="lazy"  src="{{ uploaded_asset(\App\Product::find($id)->thumbnail_img) }}">
                                                            </a>
                                                        </td>
                                                        <td class="product-name strong-600">
                                                            <a href="{{ route('product', \App\Product::find($id)->{'slug_'.locale()}) }}" target="_blank" class="d-block c-base-2">
                            ...
                            @if (!empty($seller_products))
                                @foreach ($seller_products as $key => $seller_product)
                                    <div class="card mb-3">
                                        <div class="card-header bg-white py-3">
                                            <h5 class="heading-6 mb-0">{{ \App\Shop::where('user_id', $key)->first()->{'name_'.locale()} }} Products</h5>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    <table class="table-cart">
                                                        <tbody>
                                                            ...
                                                            <tr class="cart-item">
                                                                ...
                                                                <td class="product-name strong-600">
                                                                    <a href="{{ route('product', \App\Product::find($id)->{'slug_'.locale()}) }}" target="_blank" class="d-block c-base-2">
                                                                        {{ \App\Product::find($id)->{'name_'.locale()} }}
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                            @endforeach
