                                ...
                                <form id="sort_orders" action="" method="GET">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control selectpicker form-control-sm"  name="seller_status" data-minimum-results-for-search="Infinity"  onchange="sort_orders()">
                                                @if(empty($seller_status))
                                                    <option>{{translate('Filter by Accept Or Reject')}}</option>
                                                @endif
                                        ...
                                        @foreach ($orders as $key => $order_id)
                                            ...
                                            @if($order != null)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($order->user_id != null && isset($order->user))
                                                            {{ $order->user->name }}
                                                        @else
