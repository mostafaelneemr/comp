...
<div class="product-choose-list">
    <div class="product-choose">
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <select name="seller_id" class="form-control seller_id aiz-selectpicker" data-live-search="true"
                    data-selected-text-format="count" required>
                    @foreach (\App\Seller::all() as $key => $seller)
                        <option value="{{ $seller->id }}" @if ($coupon_det->seller_id == $seller->id) selected @endif>
