...
class CustomerPackageController extends Controller
{
    ...
    {
        $customer_packages = CustomerPackage::all(['*', 'logo_' . locale() . ' as logo']);
    ...
    public function store(Request $request)
    {
        ...
        $customer_package->name_en = $request->name_en;
        $customer_package->name_ar = $request->name_ar;
        $customer_package->amount = $request->amount;
        $customer_package->product_upload = $request->product_upload;
        $customer_package->logo_ar = $request->logo_ar;
        $customer_package->logo_en = $request->logo_en;
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($customer_package->save()) {
            ...
            if ($request->button != 'save') {
                ...
                return redirect()->route('customer_packages.edit', encrypt($customer_package->id));
            }
        } else {
            flash(translate('Something went wrong'))->error();
            return back();
