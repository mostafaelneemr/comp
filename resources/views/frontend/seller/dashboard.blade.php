                            ...
                            <div class="col-md-8">
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3 category-widget">
                                        <ul class="clearfix">
                                            @foreach (\App\Category::where('published',true)->select(['*','name_'.locale().' as name'])->get() as $key => $category)
                                        ...
                                        <div class="form-box-content p-3">
                                            @if($seller_package != null)
                                                <div class="form-box-content p-2 category-widget text-center">
                                                    <center><img alt="Package Logo" src="{{ uploaded_asset($seller_package->{'logo_'.locale()}) }}" style="height:100px; width:90px;"></center>
                                                    <br>
                                                    ...
                                                    <strong><p><div class="name mb-0">{{ translate('Current Package')}}: {{ $seller_package->{'name_'.locale()} }} <span class="ml-2"><i class="fa fa-check-circle" style="color:green"></i></span></div></p></strong>
                                                </div>
                                            @else
                                                <div class="form-box-content p-2 category-widget text-center">
