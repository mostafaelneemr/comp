                                        ...
                                        <div class="col-md-6">
                                            <table class="details-table table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ json_decode($order->shipping_address)->address }}, {{ json_decode($order->shipping_address)->city }}, {{ \App\Country::where('id',json_decode($order->shipping_address)->country)->value('name_'.locale()) }}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($orderDetail->product != null)
                                                                <a href="{{ route('product', $orderDetail->product->{'slug_'.locale()}) }}" target="_blank">
                                                                    {{ $orderDetail->product->{'name_'.locale()} }}
                                                                </a>
                                                            @else
