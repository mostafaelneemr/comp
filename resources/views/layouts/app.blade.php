...
<head>
	...
	<link name="favicon" type="image/x-icon"
        href="{{ uploaded_asset(\App\GeneralSetting::first(['favicon_' . locale() . ' as favicon'])->favicon) }}"
        rel="shortcut icon" />
    ...
    @endif
	<link rel="stylesheet" href="{{ static_asset('css/aiz-core.css') }}">
...
<body class="">
	...
	<script src="{{ static_asset('js/aiz-core.js') }}" ></script>
    ...
    <script type="text/javascript">
        ...
        function menuSearch(){
			...
			items = items.filter(function(i,item){
				// console.log($(item).find(".aiz-side-nav-text")[0].innerText);
