...
@section('content')
    <div class="col-lg-8 mx-auto">
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('regions.store') }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Light shipping Cost') }}" id="shipping_cost"
                    ...
                    <div class="form-group row row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" placeholder="{{ translate('Heavy shipping Cost') }}"
                                id="shipping_cost_high" name="shipping_cost_high" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{ translate('Light shipping duration') }}"
                                id="shipping_duration" name="shipping_duration" class="form-control" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" placeholder="{{ translate('Heavy shipping duration') }}"
                                id="shipping_duration_high" name="shipping_duration_high" class="form-control" required>
                        </div>
                    </div>
