...
@section('content')
    ...
    <div class="card">
        ...
        <div class="row gutters-5">
            <div class="col text-center text-md-left p-15" style="padding: 2em">
                <address>
                                ...
                                <td>
                                    @if ($orderDetail->product != null)
                                        <strong><a
                                                ...
                                                target="_blank"
                                                class="text-muted">{{ $orderDetail->product->{'name_' . locale()} }}</a></strong>
                                ...
                                <td>
                                    ...
                                    @elseif ($orderDetail->shipping_type == 'pickup_point')
                                        @if ($orderDetail->pickup_point != null)
                                            {{ $orderDetail->pickup_point->{'name_' . locale()} }}
