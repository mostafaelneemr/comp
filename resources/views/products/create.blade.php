                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="name_en"
                                        ...
                                        onkeyup="makeSlugen(this.value)" onchange="update_sku()" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="name_ar"
                                        ...
                                        onkeyup="makeSlugar(this.value)" onchange="update_sku()" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control aiz-selectpicker" multiple="" name="hash_tags[]"
                                        id="hash_tags" data-placeholder="Choose ..." data-live-search="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="slug_en" name="slug_en" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="slug_ar" name="slug_ar" required
                                        placeholder="{{ translate('Meta Title Arabic') }}">
                                </div>
                            </div>
                        </div>
