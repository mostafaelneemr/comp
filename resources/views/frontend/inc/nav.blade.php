                    ...
                    <ul class="inline-links d-lg-inline-block d-flex justify-content-between">
                        <li class="dropdown" id="lang-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" height="11"
                                    data-src="{{ my_asset('frontend/images/icons/flags/' . $locale . '.png') }}"
                                    class="flag lazyload"
                            ...
                            <ul class="dropdown-menu">
                                @foreach (\App\Language::all() as $key => $language)
                                    <li class="dropdown-item @if ($locale==$language) active @endif">
                                        <a href="{{ route('language.change', ['lang' => $language->code]) }}" data-flag="{{ $language->code }}"><img
                                                src="{{ my_asset('frontend/images/placeholder.jpg') }}"
                                                data-src="{{ my_asset('frontend/images/icons/flags/' . $language->code . '.png') }}"
                        ...
                        <li class="dropdown" id="currency-change">
                            ...
                            <a href="" class="dropdown-toggle top-bar-item" data-toggle="dropdown">
                                ...
                                {{ \App\Currency::where('code', $currency_code)->first()->{'symbol_' . locale()} }}
                            </a>
                            <ul class="dropdown-menu">
                                @foreach (\App\Currency::where('status', 1)->get() as $key => $currency)
                                    <li class="dropdown-item @if ($currency_code==$currency->
                                        code) active @endif">
                                        <a href="" data-currency="{{ $currency->code }}">{{ $currency->$name }}
                                            ({{ $currency->{'symbol_' . locale()} }})</a>
                                    </li>
                                @endforeach
                            </ul>
                        </li>
                    ...
                    <ul class="inline-links">
                        <li>
                            <a href="{{ route('orders.track') }}"
                                class="top-bar-item">{{ translate('Track Order') }}</a>
                        </li>
                        @auth
                            @if (Auth::user()->user_type == 'admin')
                                <li>
                                    <a href="{{ route('admin.dashboard') }}"
                                        class="top-bar-item">{{ translate('My Panel') }}</a>
                                </li>
                                <li>
                            ...
                            @elseif(Auth::user()->user_type == 'customer')
                                ...
                                @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                    <li>
                                        <a href="{{ route('shops.create') }}" class="top-bar-item" style="background: #e62e04;
                                                    padding: 5px;
                                                border-radius: 5px;
                                                margin-top: 5px;color: #fff;">{{ translate('Be A Seller') }}
                                        </a>
                                    </li>
                                @endif
                            @endif
                        ...
                        @else
                            ...
                            <li>
                                <a href="{{ route('user.registration') }}"
                                    class="top-bar-item">{{ translate('Registration') }}</a>
                            </li>
                            @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                <li>
                                    <a href="{{ route('shops.create') }}" class="top-bar-item" style="background: #e62e04;
            ...
            <div class="side-menu closed">
                <div class="side-menu-header ">
                    ...
                    @auth
                        <div class="widget-profile-box px-3 py-4 d-flex align-items-center">
                            @if (Auth::user()->avatar_original != null)
                                <div class="image "
                                    style="background-image:url('{{ my_asset(Auth::user()->avatar_original) }}')"></div>
                            @else
                                <div class="image "
                                    style="background-image:url('{{ my_asset('frontend/images/user.png') }}')"></div>
                            @endif
                    ...
                    @else
                        <div class="widget-profile-box px-3 py-4 d-flex align-items-center">
                            <div class="image "
                                style="background-image:url('{{ my_asset('frontend/images/icons/user-placeholder.jpg') }}')">
                            </div>
                        </div>
                        <div class="side-login px-3 pb-3">
                                    ...
                                    <a href="{{ route('conversations.index') }}"
                                        ...
                                        <span class="category-name">
                                            ...
                                            @if (count($conversation) > 0)
                                                <span class="ml-2"
                                                    style="color:green"><strong>({{ count($conversation) }})</strong></span>
                                            @endif
                                        </span>
                                    </a>
                                </li>
                        ...
                        <div class="widget-balance py-3">
                            <div class="text-center">
                                <div class="heading-4 strong-700 mb-4">
                                    ...
                                    @endphp
                                    <small
                                        class="d-block text-sm alpha-5 mb-2">{{ translate('Your earnings (current month)') }}</small>
                        ...
                        <div class="d-flex">
                            ...
                            <a class="navbar-brand w-100" href="{{ route('home') }}">
                                ...
                                @if ($generalsetting->{'logo_' . locale()} != null)
                                    <img src="{{ uploaded_asset($generalsetting->{'logo_' . locale()}) }}"
                                        alt="{{ env('APP_NAME') }}">
                                @else
                                    <img src="{{ my_asset('frontend/images/logo/logo.png') }}"
                                        alt="{{ env('APP_NAME') }}">
                                @endif
                            </a>
                            ...
                            @if (Route::currentRouteName() != 'home' && Route::currentRouteName() != 'categories.all')
                                <div class="d-none d-xl-block category-menu-icon-box">
                                    <div class="dropdown-toggle navbar-light category-menu-icon"
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-compare-box" id="compare">
                                        <a href="{{ route('compare') }}" class="nav-box-link">
                                            ...
                                            <span
                                                class="nav-box-text d-none d-xl-inline-block">{{ translate('Compare') }}</span>
                                            @if (Session::has('compare'))
                                                <span
                                                    class="nav-box-number">{{ count(Session::get('compare')) }}</span>
                                            @else
                                ...
                                <div class="d-none d-lg-inline-block">
                                    <div class="nav-wishlist-box" id="wishlist">
                                        <a href="{{ route('wishlists.index') }}" class="nav-box-link">
                                            ...
                                            <span
                                                class="nav-box-text d-none d-xl-inline-block">{{ translate('Wishlist') }}</span>
                                            @if (Auth::check())
                                                <span
                                                    class="nav-box-number">{{ count(Auth::user()->wishlists) }}</span>
                                            @else
                                                <span class="nav-box-number">0</span>
                                            @endif
                                        </a>
                                ...
                                <div class="d-inline-block" data-hover="dropdown">
                                    <div class="nav-cart-box dropdown" id="cart_items">
                                        <a href="" class="nav-box-link" data-toggle="dropdown" aria-haspopup="true"
                                            ...
                                            @if (Session::has('cart'))
                                                <span
                                                    class="nav-box-number">{{ count(Session::get('cart')) }}</span>
                                            @else
                                                <span class="nav-box-number">0</span>
                                            @endif
                                        </a>
                                                ...
                                                <div class="dropdown-cart px-0">
                                                    @if (Session::has('cart'))
                                                        @if (count($cart = Session::get('cart')) > 0)
                                                            ...
                                                            <div class="dropdown-cart-items c-scrollbar">
                                                                ...
                                                                @foreach ($cart as $key => $cartItem)
                                                                    @php
                                                                        $product = \App\Product::select(['*', 'name_' . locale() . ' as name', 'slug_' . locale() . ' as slug'])->find($cartItem['id']);
                                                                    ...
                                                                    <div class="dc-item">
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="dc-image">
                                                                                <a
                                                                                    href="{{ route('product', $product->{'slug_' . locale()}) }}">
                                                                                    <img src="{{ my_asset('frontend/images/placeholder.jpg') }}"
                                                                                        data-src="{{ uploaded_asset($product->thumbnail_img) }}"
                                                                                        class="img-fluid lazyload"
                                                                                        alt="{{ __($product->{'name_' . locale()}) }}">
                                                                                </a>
                                                                            </div>
                                                        ...
                                                        @else
                                                            <div class="dc-header">
                                                                <h3 class="heading heading-6 strong-700">
                                                                    {{ translate('Your Cart is empty') }}</h3>
                                                            </div>
                                                        @endif
                                                    @else
                                                        <div class="dc-header">
                        ...
                        <div class="category-sidebar" id="category-sidebar">
                            <div class="all-category">
                                ...
                                <a href="{{ route('categories.all') }}"
                                    class="d-inline-block">{{ translate('See All') }} ></a>
                            </div>
                            <ul class="categories">
                                @foreach (\App\Category::where('level', 0)->where('published', true)->select(['name_' . locale() . ' as name', 'id', 'slug_ar', 'slug_en', 'icon'])->take(11)->get()
    as $key => $category)
                                    @php
                                        $brands = [];
                                    @endphp
                                    <li class="category-nav-element" data-id="{{ $category->id }}">
                                        <a href="{{ route('products.category', $category->{'slug_' . locale()}) }}">
                                            <img class="cat-image lazyload"
                                                src="{{ my_asset('frontend/images/placeholder.jpg') }}"
                                                data-src="{{ uploaded_asset($category->icon) }}" width="30"
                                                alt="{{ $category->name }}">
        ...
        <div class="secound-bar">
            <ul class="mobile-hor-swipe text-center" id="secound-nave-new">

               
                @foreach (\App\NavLink::get() as $NavLink)
                <li class="list-inline-item">
                    <a href="{{ $NavLink->link }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                        {{ $NavLink->{'title_' . locale()} }}
                    </a>
                </li>
                    @endforeach
