            ...
            <table class="table aiz-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th data-breakpoints="md">{{ translate('Seller Order Status') }}</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge badge--2 mr-4">
                                    @if (empty($order->orderDetails->first()->seller_status))
                                        <i class="bg-green"></i> {{ translate('Pending') }}
                                    @else
                                        <i class="bg-red"></i>
                                        {{ translate(ucfirst(str_replace('_', ' ', $order->orderDetails->first()->seller_status))) }}
                                    @endif
                                </span>
                            </td>
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1)
                            ...
                            <td class="text-right">
                                <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                                    href="{{ route('sales.show', encrypt($order->id)) }}"
