<form action="{{ route('currency.store') }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" placeholder="{{translate('Symbol English')}}" id="symbol_en" name="symbol_en" class="form-control" required>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-from-label" for="symbol_ar">{{translate('Symbol Aabic')}}</label>
            <div class="col-sm-10">
                <input type="text" placeholder="{{translate('Symbol Aabic')}}" id="symbol_ar" name="symbol_ar" class="form-control" required>
            </div>
        </div>
        <div class="form-group row">
