...
<body>
	<div style="margin-left:auto;margin-right:auto;">
	    ...
	    <div style="padding:0 1.5rem;display: block;margin-bottom: 10px;">
	        <table style="width: 40%;margin-right:auto;" class="text-right sm-padding border-bottom small strong">
		        <tbody>
			        <tr>
