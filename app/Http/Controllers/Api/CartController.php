...
class CartController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        return response()->json([
            'message' => trans('messages.Product added to cart successfully')
        ]);
    }
    ...
    public function changeQuantity(Request $request)
    {
        ...
        return response()->json(['message' => trans('messages.Cart updated')], 200);
    }

    public function destroy($id)
    {
        Cart::destroy($id);
        return response()->json(['message' => trans('messages.Product is successfully removed from your cart')], 200);
    }
}
