    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('refundResones.update', $RefundResone->id) }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('Arabic Resone') }}" id="resone_ar"
                                    name="resone_ar" value="{{ $RefundResone->resone_ar }}" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="{{ translate('English Resone') }}" id="resone_en"
                                    name="resone_en" value="{{ $RefundResone->resone_en }}" class="form-control" required>
                            </div>
                        </div>
