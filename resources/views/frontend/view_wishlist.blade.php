                                        ...
                                        <div class="card card-product mb-3 product-card-2">
                                            <div class="card-body p-3">
                                                <div class="card-image">
                                                    <a href="{{ route('product', $wishlist->product->{'slug_'.locale()}) }}" class="d-block" style="background-image:url('{{ uploaded_asset($wishlist->product->thumbnail_img) }}');">
                                                    </a>
                                                </div>

                                                <h2 class="heading heading-6 strong-600 mt-2 text-truncate-2">
                                                    <a href="{{ route('product', $wishlist->product->{'slug_'.locale()}) }}">{{ $wishlist->product->{'name_'.locale()} }}</a>
                                                </h2>
