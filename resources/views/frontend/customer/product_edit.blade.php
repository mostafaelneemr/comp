                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text"  value="{{ $product->name_en }}" class="form-control mb-3" name="name_en" placeholder="{{ translate('Product Name English')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" value="{{ $product->name_ar }}" class="form-control mb-3" name="name_ar" placeholder="{{ translate('Product Name Arabic')}}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select a Category') }}" id="categories" name="category_id" required>
                                                    @foreach($categories as $category)
            	                                	    <option value="{{$category->id}}" <?php if($product->category_id == $category->id) echo "selected"; ?> >{{ $category->{'name_'.locale()} }}</option>
            	                                	@endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select a brand') }}" id="brands" name="brand_id">
                                                    ...
                                                    @foreach (\App\Brand::all() as $brand)
                                                        <option value="{{ $brand->id }}" @if($brand->id == $product->brand_id) selected @endif>{{ $brand->{'name_'.locale()} }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Location Ar') }} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="location_ar" placeholder="{{ translate('Location Ar') }}" value="{{ $product->location_ar }}" required>
                                        </div>
                                    </div>
                                    
                                     <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Location EN') }} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3" name="location_en" placeholder="{{ translate('Location EN') }}" value="{{ $product->location_en }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_en[]" placeholder="{{ translate('Type & hit enter English') }}" value="{{ $product->tags_en }}" data-role="tagsinput">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control mb-3 tagsInput" name="tags_ar[]" value="{{ $product->tags_ar }}" placeholder="{{ translate('Type & hit enter Arabic') }}" data-role="tagsinput">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->thumbnail_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img src="{{ uploaded_asset($product->thumbnail_img) }}" alt="" class="img-responsive">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                @if ($product->meta_img != null)
                                                    <div class="col-md-3">
                                                        <div class="img-upload-preview">
                                                            <img src="{{ uploaded_asset($product->meta_img) }}" alt="" class="img-responsive">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-10">
                                            <input type="number" min="0" value="0" step="0.01" class="form-control mb-3" name="unit_discount" value="{{ $product->unit_discount }}" placeholder="{{ translate('Discount') }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
